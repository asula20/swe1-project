...
class NewsApp:
    ...
    def __init__(self, root):
        ...
        self.root.title("Learn Python")

        # ====variables========#
        self.newsCatButton = []
        self.newsCat = ["Announcements", "Fun Facts",
                        "About Us"]
        ...
        title = Label(self.root, text="FORUM", font=("times new roman", 30, "bold"),
        ...
        news_title = Label(F2, text="ANNOUNCEMENTS", font=(
        ...
        self.txtarea.insert(
            END,
            "ANNOUNCEMENT: \n Beta version of the software has been released! ")
