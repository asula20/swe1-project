...
def intro_message():
    ...
    """
    print("Welcome to this fun PYTHON quiz! \nAre you ready to test your knowledge about Python?")
    print("There are a total of 17 questions, you can skip a question anytime by typing 'skip'")
